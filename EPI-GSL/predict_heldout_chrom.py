...
from train import _edge_feature_frame, _parse_edge_feature_cols, build_edge_score_adj
...
def _load_edges_for_scoring(
    ...
    required = ["re_node_id", "promoter_node_id"]
...
def main() -> None:
    ...
    edge_index, edge_attr = _load_edges_for_scoring(
